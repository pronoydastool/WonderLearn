          ...
          >
            ...
            <div className="flex items-center justify-between w-full max-w-sm mx-auto px-4 mt-8">
              ...
              <button
                ...
                className="w-20 h-20 md:w-24 md:h-24 bg-blue-500 rounded-full flex items-center justify-center hover:bg-blue-600 transition-colors shadow-lg shadow-blue-200 active:scale-95 touch-manipulation"
              >
