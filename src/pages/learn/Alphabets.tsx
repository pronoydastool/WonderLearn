          ...
          >
            ...
            <div className="flex items-center justify-between w-full max-w-sm mx-auto px-4 mt-8">
              <button
                ...
                className="w-16 h-16 md:w-20 md:h-20 bg-slate-100 rounded-full flex items-center justify-center disabled:opacity-50 hover:bg-slate-200 transition-colors active:scale-95 touch-manipulation"
              >
              ...
              <button
                ...
                className="w-20 h-20 md:w-24 md:h-24 bg-green-500 rounded-full flex items-center justify-center hover:bg-green-600 transition-colors shadow-lg shadow-green-200 active:scale-95 touch-manipulation"
              >
              ...
              <button
                onClick={handleNext}
                className="w-16 h-16 md:w-20 md:h-20 bg-green-500 rounded-full flex items-center justify-center hover:bg-green-600 transition-colors shadow-lg shadow-green-200 active:scale-95 touch-manipulation"
              >
